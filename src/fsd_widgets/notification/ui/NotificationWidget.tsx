...
export const NotificationWidget = () => {
  ...
  return (
    <div className="mt-6 hidden w-full flex-col rounded-lg border border-yellow-500 bg-white px-3 py-3 shadow-md xl:block">
      {/* 일반 알림 */}
      <Link href="/setting/notification/alarm">
      ...
      <NotificationList
        ...
        linkPrefix="/setting/notification/alarm"
        markAsRead={markAsRead}
      />

      {/* 경조사 알림 */}
      <Link href="/setting/notification/occasion">
      ...
      <NotificationList
        ...
        linkPrefix="/setting/notification/occasion"
        markAsRead={markAsRead}
      />
    </div>
  );
