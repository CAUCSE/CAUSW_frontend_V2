import { LockerSelect } from "@/_deprecated/entities";
...
export const LockerSelectionGrid = ({
  ...
  return (
    <div className="grid h-[450px] flex-shrink-0 grid-cols-4 gap-2 overflow-y-auto p-1 pr-2 sm:h-[600px] sm:grid-cols-5 md:gap-4 xl:h-[800px]">
