...
const BoardDetailPage = async () => {
  ...
  return (
    <div className="absolute bottom-28 top-28 w-full overflow-y-auto bg-boardPageBackground scrollbar-hide md:bottom-0 md:left-40 md:right-72 md:top-0 md:w-auto">
