...
export const CommentCard = ({
  ...
  return (
    <div
      className={`rounded-post-br shadow-post-sh relative flex flex-col border pb-2 ${overlayActive ? 'bg-overlay-bg' : 'bg-white'} mb-4 max-w-sm`}
    >
      <button
      ...
      <div
        className={`absolute right-10 bottom-3 flex flex-row items-center justify-between space-x-3 px-2.5 py-1.5 ${overlayActive ? 'bg-overlay-btn' : 'bg-comment-btn'} rounded-comment-br`}
      >
