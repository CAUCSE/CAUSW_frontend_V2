...
export const VTwoForm = () => {
  ...
  return (
    <>
      <div className="bg-opacity-50 fixed inset-0 z-40 flex items-center justify-center overflow-y-auto bg-black"></div>
      <form
      ...
      >
        ...
        <button className="bg-focus mt-4 h-12 w-2/3 rounded-sm text-lg text-white hover:bg-blue-500">시작하기</button>
      </form>
    </>
  );
};
