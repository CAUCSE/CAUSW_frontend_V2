...
export const blockByPost = async (postId: string) => {
  const res: AxiosResponse<BlockRes> = await API.post(
    `/api/v1/blocks/by-post/${postId}`,
  );
  return res.data;
};
...
export const blockByComment = async (commentId: string) => {
  const res: AxiosResponse<BlockRes> = await API.post(
    `/api/v1/blocks/by-comment/${commentId}`,
  );
  return res.data;
};
...
export const blockByChildComment = async (childCommentId: string) => {
  const res: AxiosResponse<BlockRes> = await API.post(
    `/api/v1/blocks/by-child-comment/${childCommentId}`,
  );
  return res.data;
};
