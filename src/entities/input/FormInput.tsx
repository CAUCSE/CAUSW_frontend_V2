...
export const SignInInput = <T extends FieldValues>({
  ...
  <input
    ...
    {...rest}
    id="specificInput"
    className="mt-1 h-10 w-56 rounded-xl border-2 border-focus bg-black text-center text-sm text-white opacity-60 placeholder:text-center placeholder:text-xs sm:w-80 sm:placeholder:text-sm"
  />
);
