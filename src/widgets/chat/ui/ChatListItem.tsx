      ...
      <div className="flex items-center gap-3 px-1 py-4">
        ...
        <div className="flex flex-1 flex-col gap-1">
          <div className="flex items-center justify-between">
            ...
            <span className="mr-[-4px] text-sm text-gray-400">
              {chatData.time}
            </span>
          </div>

          <div className="flex items-center justify-between">
            <p className="max-w-[80%] truncate text-[15px] text-gray-700">
              {chatData.preview}
            </p>
        ...
        <div className="relative mb-auto pt-1" ref={menuRef}>
          ...
          {open && (
            <div className="absolute top-full right-0 z-10 w-24 rounded-md border bg-white shadow-md">
              <button className="w-full px-4 py-4 text-sm hover:bg-gray-100">
                상단 고정
              </button>
              <button className="w-full px-4 py-2 text-sm text-red-500 hover:bg-red-50">
                삭제
              </button>
            </div>
          )}
