...
export function WarningModal({
  ...
  return (
    <div className="bg-opacity-75 fixed inset-0 flex h-full w-full items-center justify-center bg-gray-500">
        ...
        <div className="relative flex h-1/2 w-5/6 flex-col items-center justify-center rounded-lg bg-white p-6 sm:w-1/2 lg:h-1/3">
          ...
          <>
            ...
            <div className="flex w-full flex-col items-center justify-center lg:flex-row">
              <button
                className="mr-2 mb-4 w-2/3 rounded-lg bg-red-500 py-2 text-white hover:bg-red-600"
                onClick={() => {
              ...
              <button
                className="mr-2 mb-4 w-2/3 rounded-lg bg-gray-300 py-2 text-white hover:bg-gray-400"
                onClick={() => {
                  onClose();
                }}
              >
