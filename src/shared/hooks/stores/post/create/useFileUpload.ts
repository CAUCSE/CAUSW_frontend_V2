...
const FILE_UPLOAD_RULES = {
  ...
  MAX_FILE_COUNT: 10,
  ALLOWED_EXTENSIONS: [
    "jpg", "jpeg", "png", "gif", "bmp", "mp4", "avi", "mkv", "mov", "wmv", "flv",
    "mp3", "wav", "flac", "alac", "aac", "txt", "doc", "docx", "xls", "xlsx", "ppt",
    "pptx", "pdf", "hwp", "zip", "rar", "alz"
  ],
};
...
export const useFileUpload = () => {
  ...
  const handleFileUpload = (file: File | null) => {
    ...
    if (file.size > FILE_UPLOAD_RULES.MAX_FILE_SIZE) {
      alert(
        `"${file.name}"의 크기가 ${FILE_UPLOAD_RULES.MAX_FILE_SIZE / 1024 / 1024}MB를 초과합니다.`,
      );
      return;
    }
