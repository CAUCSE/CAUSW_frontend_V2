...
export function CircleMemberManagementDetail({ userId, id, state }: ManagementDetailProp) {
  ...
  return (
    <div className="flex w-full flex-col items-center gap-[30px] px-2 py-4">
      ...
      <ManagementDetailInfoTable data={userData} titleMapping={titleMappingForCircle} />
