import { OccasionContent, OccasionDate, OccasionDetail, OccasionImage } from '@/entities';

interface OccasionNotificationProps {
  occasionId: string;
}

export const OccasionNotificationDetail = ({ occasionId }: OccasionNotificationProps) => {
